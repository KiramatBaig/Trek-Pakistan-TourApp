...
class _DestinationScreenWidgetState extends State<DestinationScreenWidget> {
  ...
  Future uploadImageToFirebase(BuildContext context) async {
    ...
    var _destinatonss = textController1.text;
    Reference firebaseStorageRef =
        FirebaseStorage.instance.ref().child('destinatonss/$fileName');
                                        ...
                                        if (querySnapshot.connectionState ==
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              Desname = list[index]['name'];
                                              // print(Desname inside);
                                              return Padding(
                                                padding: EdgeInsets.fromLTRB(
                                                    8, 8, 8, 0),
                                                child: Container(
                                                        ...
                                                        Expanded(
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: IconButton(
                                                                onPressed: () {
                                                                  createAlertDialog(context,list[index]['name']);
                                                                },
                                                                icon: Icon(
                                                                  Icons
                                                                      .delete_forever,
