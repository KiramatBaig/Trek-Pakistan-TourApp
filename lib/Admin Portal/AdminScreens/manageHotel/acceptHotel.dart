...
class acceptHotel extends StatefulWidget {
  final String title;

  acceptHotel(this.title);
  @override
  _acceptHotelState createState() => _acceptHotelState();
}


class _acceptHotelState extends State<acceptHotel> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<QuerySnapshot>(
        future: FirebaseFirestore.instance.collection('hotels').where('title',isEqualTo: widget.title).get(),
                                      ...
                                      Container(
                                        ...
                                        child: RaisedButton(
                                          ...
                                          onPressed: ()async {
                                            ...
                                            var querySnapshots = await collection.where('title',isEqualTo: widget.title).get();
