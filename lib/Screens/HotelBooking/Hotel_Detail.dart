...
class HotelDetailsPage extends StatelessWidget {
  static final String path = "lib/Screens/HotelBooking/Hotel_Detail.dart";
  final String image = "assets/images/milad2.jpg";
  @override
      ...
      body: Stack(
        children: <Widget>[
          Container(
              ...
              height: 400,
              child: Image.asset("assets/images/milad2.png", fit: BoxFit.cover)),
